...
### this implies that we estimate transitions between helath states on average in each single year between 2015-2016
...
qx <- c(0.01521, 0.02497,  0.04082, 0.06357, 0.10384, 0.16879) #from HMD, Italian males, 2017, 5-year age groups
...
forimach <- indivall %>%
 ...
 left_join(calibrmarg %>% 
  ...
  mutate(weightnew=ifelse(GALI2==3,weightnew*wmulti/4.75,weightnew)) %>%
